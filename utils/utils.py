...
def record_loss2(loss_csv, epoch, iteration, epoch_time, lr, train_loss, lossGrad, test_loss):
    """ Record many results."""
    loss_csv.write(
        '{},{},{},{},{},{},{}\n'.format(epoch, iteration, epoch_time, lr, train_loss, lossGrad,
                                           test_loss))
    loss_csv.flush()
    loss_csv.close


def record_loss_gain(loss_csv, epoch, iteration, epoch_time, lr, train_loss, train_gain_loss, test_loss):
    """ Record many results."""
    loss_csv.write(
        '{},{},{},{},{},{},{}\n'.format(epoch, iteration, epoch_time, lr, train_gain_loss, train_loss, test_loss))
    loss_csv.flush()
    loss_csv.close
